...
(à l’\cref{app:setups}). Le but était d’avoir à minima les raies de \ce{CO} et
...
présentent les observations que nous avons pu faire de la raie de \ce{^12CO}
...
apparaît sur la carte \cref{fig:mapC17O}, ou l’on a choisi le \ce{^17CO}, qui a
...
calculé en dehors de la zone portant intérêt) du \ce{^12CO} dans les zones de
...
\begin{figure}[!ht]
    ...
    \caption{Raie complète de \ce{^12CO} (2→1).}
    \label{fig:12COfull}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{Partie inférieure de la raie de \ce{^12CO} (2→1).}
    \label{fig:12COblue}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{Partie supérieure de la raie de \ce{^12CO} (2→1).}
    \label{fig:12COred}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{
        Carte des flots observés de CO. En bleu le \ce{^12CO} « blueshifté ».
        En rouge le flot « redshifté ». Les isocontours de vitesse sont pris
        avec comme référence la vitesse de la raie principale de \ce{^12CO}
        (2→1) à \SI{230.538}{\giga\hertz}, observée dans le \setup{} à \unmm.
        Les bins de densité ont été réalisés avec la raie de \ce{^17CO}.
    }
    \label{fig:mapC17O}
\end{figure}
